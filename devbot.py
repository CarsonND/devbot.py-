...
r = requests.get(   "https://api.webex.com/v1/rooms",
...
# 5. Provide the URL to the Webex Teams messages API.
    r = requests.get("https://api.webex.com/v1/messages", 
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "XcD9eGs5LpgM5v6xTGjKBCZWeAEHyj0X"
                               }
...
# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": https://api.webex.com/v1/messages,
        ...
        r = requests.post( requests.post(post_url, data=json.dumps(PostData), headers=HTTPHeaders) 
